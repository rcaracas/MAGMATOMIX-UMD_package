...
@author: Razvan Caracas, Anais Kobsch, Natalia V. Solomatova, Xi Zhu
"""
...
def main(argv):
    ...
    try:
        ...
        print ('VaspParser2umd.py -f <OUTCAR_filename> -i <InitialStep>')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print ('VaspParser2umd.py program to translate VASP outcar files into UMD ascii format file')
            print ('VaspParser2umd.py -f <OUTCAR_filename> -i <InitialStep>')
