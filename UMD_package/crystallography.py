...
class Atom(object):
    def __init__(self, name = 'XXX', symbol='X', znucl = 1, mass=0.0, magnet=0.0, charge=0.0, xred = None, xcart = None, absxcart = None, vels = None, forces = None, diffcoords = None):
        ...
        #(self.name,self.znucl,self.mass)=Elements2rest(self.symbol)
...
class Lattice(object):
    ...
    def makevolume(self):
        ...
        #print('ts for voluem are',t1,t2,t3)
        #cellvolume  = self.rprimd[0][0] * t1 + self.rprimd[1][0] * t2 + self.rprimd[2][0] * t3
        #print('volume is',cellvolume)
        return cellvolume
    def makegprimd(self):
        ...
        #print('at this point, rprimd is ',self.rprimd,'and det is ',det)
        dd = 1.0
        if (det>1.0E-06):
            dd = 1.0/det
        else:
    ...
    def getdensity(self):
        ...
        #print('cellvolume is ',self.cellvolume)
        for itypat in range(self.ntypat):
            ...
            #print(atomicname,atomicsymbol, atomicnumber,self.masses[itypat],self.types[itypat],' no. of time')
